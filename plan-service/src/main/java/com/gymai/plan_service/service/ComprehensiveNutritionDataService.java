...
public class ComprehensiveNutritionDataService {
        ...
        private void initializeComprehensiveFoodData() {
                List<Food> foods = Arrays.asList(
                                ...
                                // GRAINS & CEREALS
                                new Food("Oats (1 cup)", 389, 16.9, 66.3, 6.9, 10.6, "VEG", "BREAKFAST", "GRAINS"),
                                new Food("Muscle Oats (Guru Mann Recipe)", 595, 35.0, 80.0, 15.0, 12.0, "VEG",
                                                "BREAKFAST", "GRAINS"),
                                new Food("Recovery Oats", 595, 35.0, 46.0, 10.0, 8.0, "VEG", "BREAKFAST", "GRAINS"),
                                new Food("Muesli (1 cup)", 352, 9.7, 66.0, 5.9, 7.3, "VEG", "BREAKFAST", "GRAINS"),
                                new Food("Whole Grain Cereals", 379, 13.0, 67.0, 6.0, 10.0, "VEG", "BREAKFAST",
                                                "GRAINS"),
                                new Food("Daliya (Broken Wheat)", 342, 12.0, 69.0, 1.8, 12.5, "VEG", "BREAKFAST",
                                                "GRAINS"),
                                new Food("Multi Grain Mix (Guru Mann)", 410, 30.0, 50.0, 10.0, 8.0, "VEG", "BREAKFAST",
                                                "GRAINS"),
                                new Food("Quinoa (cooked)", 222, 8.0, 39.0, 3.6, 5.2, "VEG", "BREAKFAST", "GRAINS"),

                                // BREAKFAST BREADS
                                new Food("Whole Wheat Bread (1 slice)", 82, 4.2, 13.7, 1.1, 2.5, "VEG", "BREAKFAST",
                                                "GRAINS"),
                                new Food("Whole Wheat Bread (3 slices)", 247, 12.6, 41.0, 3.4, 7.4, "VEG", "BREAKFAST",
                                                "GRAINS"),
                                new Food("Banana Bread Toast (Guru Mann)", 500, 28.0, 62.0, 15.0, 7.0, "VEG",
                                                "BREAKFAST", "GRAINS"),

                                // BREAKFAST PROTEINS
                                new Food("Eggs (1 whole)", 68, 5.5, 0.4, 4.4, 0, "VEG", "BREAKFAST", "PROTEIN"),
                                new Food("Egg Whites (1 white)", 17, 3.6, 0.2, 0.1, 0, "VEG", "BREAKFAST", "PROTEIN"),
                                new Food("Scrambled Eggs (6 whites)", 102, 21.6, 1.2, 0.6, 0, "VEG", "BREAKFAST",
                                                "PROTEIN"),
                                new Food("Vegetable Omelet", 392, 36.0, 35.0, 12.0, 3.0, "VEG", "BREAKFAST", "PROTEIN"),
                                new Food("Spinach Omelet (Guru Mann)", 410, 30.0, 50.0, 10.0, 4.0, "VEG", "BREAKFAST",
                                                "PROTEIN"),

                                // BREAKFAST DAIRY & ALTERNATIVES
                                new Food("Non Fat Milk (1 cup)", 42, 3.4, 5.0, 0.2, 0, "VEG", "BREAKFAST", "DAIRY"),
                                new Food("Low Fat Milk (1 glass)", 102, 8.1, 12.2, 2.4, 0, "VEG", "BREAKFAST", "DAIRY"),
                                ...
                                new Food("Protein Smoothie (Guru Mann)", 410, 30.0, 50.0, 10.0, 3.0, "VEG", "BREAKFAST",
                                                "PROTEIN"),

                                // BREAKFAST SUPPLEMENTS
                                new Food("Whey Protein (1 scoop)", 120, 24.0, 2.0, 1.0, 0, "VEG", "BREAKFAST",
                                                "SUPPLEMENTS"),
                                ...
                                // MORNING SNACKS
                                new Food("Apple with Peanut Butter", 320, 8.0, 35.0, 16.0, 6.0, "VEG", "SNACK",
                                                "FRUITS"),
                                new Food("Protein Cupcake (Guru Mann)", 295, 34.0, 6.0, 15.0, 2.0, "VEG", "SNACK",
                                                "PROTEIN"),
                                new Food("Banana Smoothie", 250, 8.0, 45.0, 6.0, 4.0, "VEG", "SNACK", "FRUITS"),
                                ...
                                new Food("Peanut Butter (1 tbsp)", 94, 4.0, 3.1, 8.1, 0.9, "VEG", "SNACK", "NUTS"),
                                new Food("Almond Butter (1 tbsp)", 98, 3.7, 3.2, 9.0, 1.6, "VEG", "SNACK", "NUTS"),

                                // FRUITS
                                new Food("Apple (1 medium)", 52, 0.3, 13.8, 0.2, 2.4, "VEG", "SNACK", "FRUITS"),
                                new Food("Banana (1 medium)", 89, 1.1, 22.8, 0.3, 2.6, "VEG", "SNACK", "FRUITS"),
                                new Food("Orange (1 medium)", 47, 0.9, 11.8, 0.1, 2.4, "VEG", "SNACK", "FRUITS"),
                                new Food("Pear (1 medium)", 57, 0.4, 15.2, 0.1, 3.1, "VEG", "SNACK", "FRUITS"),
                                new Food("Strawberries (1 cup)", 49, 1.0, 11.7, 0.5, 3.0, "VEG", "SNACK", "FRUITS"),
                                new Food("Blueberries (1 cup)", 84, 1.1, 21.5, 0.5, 3.6, "VEG", "SNACK", "FRUITS"),
                                new Food("Papaya (1 cup)", 55, 0.9, 13.7, 0.2, 2.5, "VEG", "SNACK", "FRUITS"),
                                new Food("Guava (1 medium)", 112, 4.2, 23.6, 1.6, 8.9, "VEG", "SNACK", "FRUITS"),
                                new Food("Black Grapes (1 cup)", 104, 1.1, 27.3, 0.2, 1.4, "VEG", "SNACK", "FRUITS"),
                                new Food("Pomegranate (1 cup)", 134, 2.9, 30.0, 1.9, 6.4, "VEG", "SNACK", "FRUITS"),

                                // HEALTHY SNACKS
                                new Food("Roasted Chickpeas (1 cup)", 269, 12.1, 45.0, 4.3, 9.9, "VEG", "SNACK",
                                                "PROTEIN"),
                                new Food("Roasted Soy Beans", 387, 34.0, 28.1, 18.6, 7.0, "VEGAN", "SNACK", "PROTEIN"),
                                new Food("Protein Laddoo (Guru Mann)", 320, 25.0, 15.0, 18.0, 3.0, "VEG", "SNACK",
                                                "PROTEIN"),
                                new Food("Fresh Juice with Channa", 401, 34.0, 46.0, 9.0, 8.0, "VEG", "SNACK",
                                                "FRUITS"),

                                // ===== LUNCH FOODS =====

                                // RICE & GRAINS
                                new Food("Brown Rice (cooked, 1 cup)", 216, 5.0, 45.0, 1.8, 3.5, "VEG", "LUNCH",
                                                "GRAINS"),
                                new Food("Super Rice (Guru Mann)", 500, 32.0, 56.0, 16.0, 2.0, "VEG", "LUNCH",
                                                "GRAINS"),
                                new Food("Sweet Muscle Rice", 597, 33.0, 78.0, 17.0, 4.0, "VEG", "LUNCH", "GRAINS"),
                                new Food("Recovery Rice", 268, 20.0, 38.0, 4.0, 3.0, "VEG", "LUNCH", "GRAINS"),
                                new Food("Rice Palao", 320, 12.0, 55.0, 8.0, 4.0, "VEG", "LUNCH", "GRAINS"),

                                // ROTIS & BREADS
                                new Food("Whole Wheat Roti (1 medium)", 71, 2.7, 15.2, 0.4, 2.0, "VEG", "LUNCH",
                                                "GRAINS"),
                                new Food("Chapati (1 medium)", 71, 2.7, 15.2, 0.4, 2.0, "VEG", "LUNCH", "GRAINS"),
                                new Food("Super Roti (Guru Mann)", 494, 32.0, 51.0, 18.0, 8.0, "VEG", "LUNCH",
                                                "GRAINS"),

                                // LEGUMES & BEANS
                                new Food("Lentils (Dal, cooked)", 116, 9.0, 20.1, 0.4, 7.9, "VEG", "LUNCH", "PROTEIN"),
                                ...
                                new Food("Chickpeas (cooked)", 164, 8.9, 27.4, 2.6, 7.6, "VEG", "LUNCH", "PROTEIN"),
                                ...
                                // VEGETABLES
                                new Food("Spinach (cooked)", 23, 2.9, 3.6, 0.4, 2.2, "VEG", "LUNCH", "VEGETABLES"),
                                new Food("Broccoli (cooked)", 34, 2.8, 6.6, 0.4, 2.6, "VEG", "LUNCH", "VEGETABLES"),
                                new Food("Cauliflower (cooked)", 25, 1.9, 5.0, 0.3, 2.0, "VEG", "LUNCH", "VEGETABLES"),
                                ...
                                new Food("Green Peas", 81, 5.4, 14.5, 0.4, 5.7, "VEG", "LUNCH", "VEGETABLES"),
                                new Food("Sweet Potato (cooked)", 86, 1.6, 20.1, 0.1, 3.0, "VEG", "LUNCH",
                                                "VEGETABLES"),
                                new Food("Carrot (cooked)", 41, 0.9, 9.6, 0.2, 2.8, "VEG", "LUNCH", "VEGETABLES"),
                                ...
                                // PROTEIN SOURCES
                                new Food("Paneer (100g)", 265, 18.3, 1.2, 20.8, 0, "VEG", "LUNCH", "PROTEIN"),
                                new Food("Fresh Paneer", 265, 18.3, 1.2, 20.8, 0, "VEG", "LUNCH", "PROTEIN"),
                                new Food("Low Fat Paneer", 206, 20.0, 3.0, 12.0, 0, "VEG", "LUNCH", "PROTEIN"),
                                new Food("Grilled Paneer", 265, 18.3, 1.2, 20.8, 0, "VEG", "LUNCH", "PROTEIN"),
                                new Food("Tofu (100g)", 76, 8.1, 1.9, 4.8, 0.3, "VEGAN", "LUNCH", "PROTEIN"),
                                new Food("Soy Chunks (50g)", 173, 26.0, 16.5, 0.3, 6.5, "VEGAN", "LUNCH", "PROTEIN"),
                                new Food("Tempeh (100g)", 193, 19.0, 9.4, 11.0, 9.0, "VEGAN", "LUNCH", "PROTEIN"),

                                // NON-VEG PROTEINS
                                new Food("Grilled Chicken (100g)", 165, 31.0, 0, 3.6, 0, "NON_VEG", "LUNCH", "PROTEIN"),
                                new Food("Chicken Breast (100g)", 165, 31.0, 0, 3.6, 0, "NON_VEG", "LUNCH", "PROTEIN"),
                                new Food("Chicken Curry", 200, 25.0, 8.0, 8.0, 1.0, "NON_VEG", "LUNCH", "PROTEIN"),
                                new Food("Tandoori Chicken", 150, 28.0, 5.0, 2.5, 0, "NON_VEG", "LUNCH", "PROTEIN"),
                                new Food("Chicken Drumstick (2 pieces)", 172, 28.3, 0, 5.7, 0, "NON_VEG", "LUNCH",
                                                "PROTEIN"),
                                new Food("Fish (100g)", 206, 22.0, 0, 12.0, 0, "NON_VEG", "LUNCH", "PROTEIN"),
                                new Food("Salmon (100g)", 208, 22.0, 0, 12.4, 0, "NON_VEG", "LUNCH", "PROTEIN"),

                                // SPECIALTY LUNCH DISHES
                                new Food("Muscle Builder Potato Bowl", 490, 32.0, 68.0, 10.0, 8.0, "VEG", "LUNCH",
                                                "MIXED"),
                                new Food("Potato Bean Bowl (Guru Mann)", 410, 30.0, 50.0, 10.0, 8.0, "VEG", "LUNCH",
                                                "MIXED"),
                                new Food("Bean Bowl", 350, 20.0, 45.0, 12.0, 12.0, "VEG", "LUNCH", "PROTEIN"),
                                new Food("Paneer Sandwich", 325, 30.0, 40.0, 5.0, 4.0, "VEG", "LUNCH", "MIXED"),

                                // ===== DINNER FOODS =====

                                // DINNER MAINS
                                new Food("Roti Roll (Guru Mann)", 343, 20.0, 32.0, 15.0, 6.0, "VEG", "DINNER", "MIXED"),
                                new Food("Omelet Beans Wrap", 450, 35.0, 35.0, 20.0, 8.0, "VEG", "DINNER", "MIXED"),
                                new Food("Roti Beans Wrap", 410, 30.0, 45.0, 15.0, 10.0, "VEG", "DINNER", "MIXED"),
                                new Food("Paneer Bhurji with Roti", 404, 30.0, 44.0, 12.0, 4.0, "VEG", "DINNER",
                                                "MIXED"),
                                new Food("Boiled Egg Sabji", 410, 30.0, 50.0, 10.0, 4.0, "VEG", "DINNER", "PROTEIN"),
                                new Food("Paneer Sabji", 410, 25.0, 55.0, 10.0, 4.0, "VEG", "DINNER", "PROTEIN"),

                                // DINNER SALADS
                                new Food("Broccoli Cabbage Salad", 45, 3.0, 8.0, 0.5, 4.0, "VEG", "DINNER",
                                                "VEGETABLES"),
                                new Food("Beans Salad", 120, 8.0, 18.0, 2.0, 6.0, "VEG", "DINNER", "VEGETABLES"),
                                new Food("Mixed Vegetable Salad", 50, 2.5, 10.0, 0.5, 4.0, "VEG", "DINNER",
                                                "VEGETABLES"),
                                new Food("Cucumber Salad", 20, 1.0, 4.0, 0.1, 1.5, "VEG", "DINNER", "VEGETABLES"),

                                // DINNER SOUPS
                                new Food("Tomato Soup (homemade)", 75, 2.0, 16.0, 1.0, 3.0, "VEG", "DINNER",
                                                "VEGETABLES"),
                                new Food("Chicken Soup", 120, 12.0, 8.0, 4.0, 1.0, "NON_VEG", "DINNER", "PROTEIN"),
                                new Food("Vegetable Soup", 60, 2.5, 12.0, 0.5, 3.0, "VEG", "DINNER", "VEGETABLES"),

                                // LIGHT DINNER OPTIONS
                                new Food("Mixed Lentil with Rice", 350, 15.0, 60.0, 6.0, 10.0, "VEG", "DINNER",
                                                "MIXED"),
                                ...
                                new Food("Pre-Workout Drink", 60, 0, 15.0, 0, 0, "VEG", "PRE_WORKOUT", "SUPPLEMENTS"),

                                // POST-WORKOUT
                                new Food("Post Workout Shake", 499, 40.0, 78.0, 3.0, 0, "VEG", "POST_WORKOUT",
                                                "PROTEIN"),
                                new Food("Whey Protein Shake", 258, 36.0, 24.0, 3.0, 0, "VEG", "POST_WORKOUT",
                                                "PROTEIN"),
                                new Food("Protein Shake (Simple)", 400, 30.0, 70.0, 0, 0, "VEG", "POST_WORKOUT",
                                                "PROTEIN"),
                                new Food("Recovery Drink", 308, 25.0, 52.0, 0, 0, "VEG", "POST_WORKOUT", "PROTEIN"),

                                // ===== BEFORE BED =====

                                new Food("Protein Burfi", 279, 25.0, 11.0, 15.0, 2.0, "VEG", "BEFORE_BED", "PROTEIN"),
                                new Food("Almond Milk (warm)", 210, 16.0, 18.0, 8.0, 1.0, "VEG", "BEFORE_BED", "DAIRY"),
                                new Food("Protein Pancake", 375, 30.0, 30.0, 15.0, 3.0, "VEG", "BEFORE_BED", "PROTEIN"),
                                new Food("Rice Cake with Peanut Butter", 500, 36.0, 30.0, 15.0, 2.0, "VEG",
                                                "BEFORE_BED", "MIXED"),
                                new Food("Casein Protein", 110, 24.0, 3.0, 0.5, 0, "VEG", "BEFORE_BED", "SUPPLEMENTS"),

                                // ===== COOKING INGREDIENTS & CONDIMENTS =====

                                new Food("Olive Oil (1 tbsp)", 119, 0, 0, 13.5, 0, "VEG", "COOKING", "FATS"),
                                new Food("Coconut Oil (1 tbsp)", 117, 0, 0, 14.0, 0, "VEGAN", "COOKING", "FATS"),
                                new Food("Flaxseed Oil (1 tbsp)", 120, 0, 0, 13.6, 0, "VEGAN", "COOKING", "FATS"),
                                new Food("Honey (1 tbsp)", 64, 0.1, 17.3, 0, 0.1, "VEG", "COOKING", "CONDIMENTS"),
                                new Food("Stevia", 0, 0, 0, 0, 0, "VEG", "COOKING", "CONDIMENTS"),
                                new Food("Cinnamon (1 tsp)", 6, 0.1, 2.1, 0.1, 1.4, "VEG", "COOKING", "SPICES"),
                                new Food("Ginger", 4, 0.1, 0.9, 0.1, 0.1, "VEG", "COOKING", "SPICES"),
                                new Food("Garlic (1 clove)", 4, 0.2, 1.0, 0, 0.1, "VEG", "COOKING", "SPICES"),
                                new Food("Ketchup (1 tbsp)", 19, 0.3, 4.7, 0.1, 0.1, "VEG", "COOKING", "CONDIMENTS"),
                                new Food("Ranch Dressing (1 tbsp)", 73, 0.1, 1.4, 7.7, 0, "VEG", "COOKING",
                                                "CONDIMENTS"),
                                new Food("Lemon Juice (1 tbsp)", 4, 0.1, 1.3, 0, 0.1, "VEG", "COOKING", "FRUITS"),

                                // ===== BEVERAGES =====

                                new Food("Indian Tea (1 cup)", 1, 0, 0.7, 0, 0, "VEG", "BEVERAGES", "BEVERAGES"),
                                new Food("Herbal Tea", 1, 0, 0, 0, 0, "VEG", "BEVERAGES", "BEVERAGES"),
                                new Food("Gatorade (240ml)", 50, 0, 14.0, 0, 0, "VEG", "BEVERAGES", "BEVERAGES"),
                                new Food("Water", 0, 0, 0, 0, 0, "VEG", "BEVERAGES", "BEVERAGES"),

                                // ===== SPECIAL DIETARY NEEDS =====

                                // LOW SODIUM (for Hypertension)
                                new Food("Low Sodium Quinoa Bowl", 280, 12.0, 45.0, 8.0, 6.0, "VEG", "LUNCH", "GRAINS"),
                                new Food("Herb Seasoned Vegetables", 40, 2.0, 8.0, 0.5, 3.0, "VEG", "LUNCH",
                                                "VEGETABLES"),

                                // LOW GLYCEMIC (for Diabetes)
                                new Food("Diabetes-Friendly Oats", 150, 8.0, 25.0, 3.0, 4.0, "VEG", "BREAKFAST",
                                                "GRAINS"),
                                new Food("Low GI Fruit Bowl", 80, 1.0, 20.0, 0.3, 4.0, "VEG", "SNACK", "FRUITS"),

                                // HIGH FIBER (for Cholesterol)
                                new Food("High Fiber Bean Mix", 180, 12.0, 32.0, 1.0, 15.0, "VEG", "LUNCH", "PROTEIN"),
                                new Food("Cholesterol-Friendly Salad", 60, 3.0, 12.0, 2.0, 8.0, "VEG", "LUNCH",
                                                "VEGETABLES"),

                                // ===== MASS GAIN SPECIALTIES =====

                                new Food("Mass Gain Shake (Homemade)", 500, 37.0, 53.0, 16.0, 3.0, "VEG", "SNACK",
                                                "PROTEIN"),
                                new Food("Muscle Meat (Guru Mann)", 513, 30.0, 60.0, 17.0, 4.0, "NON_VEG", "DINNER",
                                                "PROTEIN"),
                                new Food("Power Snack", 536, 30.0, 68.0, 16.0, 5.0, "VEG", "SNACK", "MIXED"),

                                // ===== DRIED FRUITS & OTHERS =====

                                new Food("Raisins (1/4 cup)", 109, 1.0, 29.0, 0.2, 1.4, "VEG", "SNACK", "FRUITS"),
                                new Food("Dates (3 pieces)", 67, 0.4, 18.0, 0.1, 1.6, "VEG", "SNACK", "FRUITS"),
                                new Food("Cranberries (dried, 1/8 cup)", 92, 0.1, 25.0, 0.4, 1.6, "VEG", "SNACK",
                                                "FRUITS"),

                                // ===== SUPPLEMENTS & SPECIAL ITEMS =====

                                new Food("Multivitamin", 5, 0, 1.0, 0, 0, "VEG", "SUPPLEMENTS", "SUPPLEMENTS"),
                                new Food("BCAA (5g)", 10, 2.5, 0, 0, 0, "VEG", "SUPPLEMENTS", "SUPPLEMENTS"),
                                new Food("Creatine (5g)", 0, 0, 0, 0, 0, "VEG", "SUPPLEMENTS", "SUPPLEMENTS"),
                                new Food("Fish Oil (1g)", 9, 0, 0, 1.0, 0, "NON_VEG", "SUPPLEMENTS", "SUPPLEMENTS"),
        ...
        private void initializeComprehensiveExerciseData() {
                List<Exercise> exercises = Arrays.asList(
                                ...
                                // RUNNING & JOGGING
                                new Exercise("Running (10-12 kmph)", "CARDIO", "FULL_BODY", "NONE", "INTERMEDIATE",
                                                12.0,
                                                "High-intensity running",
                                                "Maintain 10-12 kmph pace, 20-30 minutes duration"),
                                new Exercise("Treadmill Running", "CARDIO", "FULL_BODY", "MACHINE", "BEGINNER", 10.0,
                                ...
                                new Exercise("Outdoor Walking", "CARDIO", "FULL_BODY", "NONE", "BEGINNER", 4.0,
                                                "Brisk outdoor walking", "Maintain 3-4 mph pace, natural arm swing"),
                                new Exercise("Incline Walking", "CARDIO", "FULL_BODY", "MACHINE", "BEGINNER", 6.0,
                                ...
                                new Exercise("Barbell Incline Press", "STRENGTH", "CHEST", "BARBELL", "INTERMEDIATE",
                                                6.5,
                                                "Incline barbell press", "45-degree angle, emphasize upper chest"),
                                new Exercise("Barbell Decline Press", "STRENGTH", "CHEST", "BARBELL", "INTERMEDIATE",
                                                6.0,
                                                "Decline barbell press", "Decline angle, focus on lower chest"),
                                new Exercise("Smith Machine Bench Press", "STRENGTH", "CHEST", "MACHINE", "BEGINNER",
                                                5.5,
                                ...
                                new Exercise("Incline Dumbbell Fly", "STRENGTH", "CHEST", "DUMBBELL", "INTERMEDIATE",
                                                5.0,
                                ...
                                new Exercise("Decline Cable Fly", "STRENGTH", "CHEST", "MACHINE", "INTERMEDIATE", 4.5,
                                                "Cable decline fly", "Low to high cable movement"),
                                new Exercise("Incline Cable Fly", "STRENGTH", "CHEST", "MACHINE", "INTERMEDIATE", 4.5,
                                ...
                                new Exercise("Machine Chest Press", "STRENGTH", "CHEST", "MACHINE", "BEGINNER", 5.0,
                                ...
                                new Exercise("Incline Push-ups", "STRENGTH", "CHEST", "NONE", "BEGINNER", 4.0,
                                                "Elevated feet push-ups", "Feet on bench, hands on ground"),
                                new Exercise("Decline Push-ups", "STRENGTH", "CHEST", "NONE", "INTERMEDIATE", 6.0,
                                ...
                                new Exercise("Wide Grip Pull-ups", "STRENGTH", "BACK", "NONE", "ADVANCED", 6.5,
                                                "Wide grip pull-ups", "Wider than shoulder width grip"),
                                new Exercise("Close Grip Pull-ups", "STRENGTH", "BACK", "NONE", "INTERMEDIATE", 6.0,
                                                "Narrow grip pull-ups", "Hands closer together"),

                                // LAT PULLDOWNS
                                new Exercise("Wide Grip Lat Pulldown", "STRENGTH", "BACK", "MACHINE", "BEGINNER", 5.0,
                                ...
                                new Exercise("Rope Lat Pulldown", "STRENGTH", "BACK", "MACHINE", "INTERMEDIATE", 5.0,
                                                "Rope attachment pulldown", "Rope handle, wide pull"),
                                new Exercise("Single Hand Lat Pulldown", "STRENGTH", "BACK", "MACHINE", "INTERMEDIATE",
                                                5.0,
                                                "Unilateral lat pulldown", "One arm at a time, focus on form"),

                                // ROWING EXERCISES
                                new Exercise("Barbell Rows", "STRENGTH", "BACK", "BARBELL", "INTERMEDIATE", 5.5,
                                ...
                                new Exercise("Close Grip Machine Rows", "STRENGTH", "BACK", "MACHINE", "INTERMEDIATE",
                                                5.5,
                                                "Close grip seated rows", "Narrow grip, squeeze shoulder blades"),
                                new Exercise("Wide Grip Barbell Rows", "STRENGTH", "BACK", "BARBELL", "INTERMEDIATE",
                                                5.5,
                                                "Wide grip bent rows", "Wider grip, upper back focus"),
                                new Exercise("Inverted Rows", "STRENGTH", "BACK", "NONE", "INTERMEDIATE", 5.0,
                                ...
                                new Exercise("Hyperextensions", "STRENGTH", "BACK", "MACHINE", "BEGINNER", 4.0,
                                                "Lower back extensions", "Hyperextension bench, back focus"),
                                new Exercise("Dumbbell Pullover", "STRENGTH", "BACK", "DUMBBELL", "INTERMEDIATE", 5.0,
                                                "Chest/back pullover", "Over bench, stretch lats"),

                                // TRAPS
                                new Exercise("Barbell Shrugs", "STRENGTH", "BACK", "BARBELL", "BEGINNER", 4.0,
                                ...
                                new Exercise("Rope Shrugs", "STRENGTH", "BACK", "MACHINE", "INTERMEDIATE", 4.0,
                                                "Cable rope shrugs", "Rope attachment, shrug motion"),
                                new Exercise("Upright Rows", "STRENGTH", "BACK", "BARBELL", "INTERMEDIATE", 4.5,
                                ...
                                new Exercise("Single Hand Dumbbell Press", "STRENGTH", "SHOULDERS", "DUMBBELL",
                                                "INTERMEDIATE", 4.5,
                                ...
                                new Exercise("Machine Side Raise", "STRENGTH", "SHOULDERS", "MACHINE", "BEGINNER", 3.5,
                                ...
                                new Exercise("Barbell Front Raise", "STRENGTH", "SHOULDERS", "BARBELL", "INTERMEDIATE",
                                                4.0,
                                ...
                                new Exercise("Plate Front Raise", "STRENGTH", "SHOULDERS", "NONE", "INTERMEDIATE", 4.0,
                                ...
                                new Exercise("Rear Delt Machine Fly", "STRENGTH", "SHOULDERS", "MACHINE", "BEGINNER",
                                                3.5,
                                ...
                                new Exercise("Dumbbell Bicep Curls", "STRENGTH", "ARMS", "DUMBBELL", "BEGINNER", 3.5,
                                ...
                                new Exercise("Close Grip Barbell Curl", "STRENGTH", "ARMS", "BARBELL", "INTERMEDIATE",
                                                4.0,
                                ...
                                new Exercise("Stiff Leg Deadlifts", "STRENGTH", "LEGS", "DUMBBELL", "INTERMEDIATE", 5.5,
                                ...
                                new Exercise("Gluteus Kickbacks", "STRENGTH", "LEGS", "MACHINE", "BEGINNER", 3.5,
                                ...
                                new Exercise("Rope Crunches", "STRENGTH", "CORE", "MACHINE", "INTERMEDIATE", 4.0,
                                ...
                                new Exercise("Decline Sit-ups", "STRENGTH", "CORE", "NONE", "INTERMEDIATE", 4.5,
                                ...
                                new Exercise("Flutter Kicks", "STRENGTH", "CORE", "NONE", "INTERMEDIATE", 4.0,
                                ...
                                new Exercise("Oblique Crunches", "STRENGTH", "CORE", "NONE", "INTERMEDIATE", 3.5,
                                ...
                                new Exercise("Battle Ropes", "CARDIO", "FULL_BODY", "RESISTANCE_BAND", "INTERMEDIATE",
                                                11.0,
