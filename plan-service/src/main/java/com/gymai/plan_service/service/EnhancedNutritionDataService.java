...
// new Food("Whole Wheat Bread", 247, 12.6, 41.0, 3.4, 7.4, "VEG", "BREAKFAST",
// "GRAINS"),
// new Food("Brown Rice", 111, 2.6, 23.0, 0.9, 1.8, "VEG", "LUNCH", "GRAINS"),
// new Food("Quinoa", 368, 14.1, 64.2, 6.1, 7.0, "VEG", "LUNCH", "GRAINS"),
// new Food("Whole Wheat Roti", 71, 2.7, 15.2, 0.4, 2.0, "VEG", "LUNCH",
// "GRAINS"),
// new Food("Muesli", 352, 9.7, 66.0, 5.9, 7.3, "VEG", "BREAKFAST", "GRAINS"),
// new Food("Whole Grain Cereal", 379, 13.0, 67.0, 6.0, 10.0, "VEG",
// "BREAKFAST",
// "GRAINS"),
// new Food("Flattened Rice (Poha)", 76, 1.4, 16.6, 0.2, 0.5, "VEG",
// "BREAKFAST",
// "GRAINS"),
...
// new Food("Chicken Breast", 165, 31.0, 0, 3.6, 0, "NON_VEG", "LUNCH",
// "PROTEIN"),
// new Food("Grilled Chicken", 239, 27.3, 0, 13.6, 0, "NON_VEG", "LUNCH",
// "PROTEIN"),
// new Food("Chicken Drumstick", 172, 28.3, 0, 5.7, 0, "NON_VEG", "LUNCH",
// "PROTEIN"),
// new Food("Salmon", 208, 22.0, 0, 12.4, 0, "NON_VEG", "LUNCH", "PROTEIN"),
// new Food("Fish (General)", 206, 22.0, 0, 12.0, 0, "NON_VEG", "LUNCH",
// "PROTEIN"),
...
// // PLANT PROTEINS
// new Food("Lentils (Dal)", 116, 9.0, 20.1, 0.4, 7.9, "VEG", "LUNCH",
// "PROTEIN"),
...
// "PROTEIN"),
// new Food("Roasted Chickpeas", 164, 6.0, 27.0, 2.5, 5.0, "VEG", "SNACK",
// "PROTEIN"),
...
// new Food("Soy Chunks", 345, 52.0, 33.0, 0.5, 13.0, "VEGAN", "LUNCH",
// "PROTEIN"),
...
// new Food("Peanut Butter", 588, 25.1, 19.6, 50.4, 6.0, "VEG", "SNACK",
// "NUTS"),
// new Food("Chia Seeds", 486, 17.0, 42.0, 31.0, 34.4, "VEGAN", "BREAKFAST",
// "NUTS"),
// new Food("Flax Seeds", 534, 18.3, 28.9, 42.2, 27.3, "VEGAN", "BREAKFAST",
// "NUTS"),
// new Food("Sesame Seeds", 573, 17.7, 23.4, 49.7, 11.8, "VEGAN", "BREAKFAST",
// "NUTS"),
// new Food("Sunflower Seeds", 584, 20.8, 20.0, 51.5, 8.6, "VEGAN", "SNACK",
// "NUTS"),
...
// new Food("Berries (Mixed)", 57, 0.7, 14.0, 0.3, 2.4, "VEG", "SNACK",
// "FRUITS"),
// new Food("Strawberries", 32, 0.7, 7.7, 0.3, 2.0, "VEG", "BREAKFAST",
// "FRUITS"),
// new Food("Blueberries", 57, 0.7, 14.5, 0.3, 2.4, "VEG", "SNACK", "FRUITS"),
// new Food("Cranberries (Dried)", 308, 0.1, 82.8, 1.4, 5.3, "VEG", "SNACK",
// "FRUITS"),
...
// new Food("Cauliflower", 25, 1.9, 5.0, 0.3, 2.0, "VEG", "LUNCH",
// "VEGETABLES"),
// new Food("Bell Pepper", 31, 1.0, 7.3, 0.3, 2.5, "VEG", "LUNCH",
// "VEGETABLES"),
...
// new Food("Green Onion", 32, 1.8, 7.3, 0.2, 2.6, "VEG", "LUNCH",
// "VEGETABLES"),
// new Food("Sweet Potato", 86, 1.6, 20.1, 0.1, 3.0, "VEG", "LUNCH",
// "VEGETABLES"),
...
// new Food("Cinnamon", 247, 4.0, 80.6, 1.2, 53.1, "VEG", "BREAKFAST",
// "SPICES"),
// new Food("Ketchup", 112, 1.7, 27.4, 0.1, 0.6, "VEG", "LUNCH", "CONDIMENTS"),

// // SPECIALIZED FOODS FROM GURU MANN PLANS
// new Food("Protein Cupcake", 295, 34.0, 6.0, 15.0, 2.0, "VEG", "SNACK",
// "PROTEIN"),
// new Food("Protein Laddoo", 320, 25.0, 15.0, 18.0, 3.0, "VEG", "SNACK",
// "PROTEIN"),
// new Food("Protein Burfi", 279, 25.0, 11.0, 15.0, 2.0, "VEG", "SNACK",
// "PROTEIN"),

// // SUPPLEMENTS (Estimated values)
// new Food("Whey Protein (per scoop)", 120, 24.0, 2.0, 1.0, 0, "VEG",
// "POST_WORKOUT",
// "PROTEIN"),
// new Food("Casein Protein (per scoop)", 110, 24.0, 3.0, 0.5, 0, "VEG",
// "BEFORE_BED",
// "PROTEIN"),
// new Food("BCAA", 10, 2.5, 0, 0, 0, "VEG", "PRE_WORKOUT", "SUPPLEMENTS"),
// new Food("Creatine", 0, 0, 0, 0, 0, "VEG", "PRE_WORKOUT", "SUPPLEMENTS"),
// new Food("Multivitamin", 5, 0, 1.0, 0, 0, "VEG", "BREAKFAST",
// "SUPPLEMENTS"));
...
// "Start with 5min warm-up at 2.8mph, maintain 6-10mph pace, focus on
// breathing"),
...
// new Exercise("Incline Barbell Press", "STRENGTH", "CHEST", "BARBELL",
// "INTERMEDIATE",
// 6.5,
// "Upper chest development",
// "45-degree incline, controlled movement, focus on upper pecs"),
// new Exercise("Decline Barbell Press", "STRENGTH", "CHEST", "BARBELL",
// "INTERMEDIATE",
// 6.0,
...
// new Exercise("Bent-over Row", "STRENGTH", "BACK", "BARBELL", "INTERMEDIATE",
// 5.5,
...
// new Exercise("Hyperextension", "STRENGTH", "BACK", "MACHINE", "BEGINNER",
// 4.0,
...
// // SHOULDER EXERCISES
// new Exercise("Overhead Press", "STRENGTH", "SHOULDERS", "BARBELL",
// "INTERMEDIATE", 5.0,
...
// new Exercise("Upright Rows", "STRENGTH", "SHOULDERS", "BARBELL",
// "INTERMEDIATE", 4.5,
...
// new Exercise("Barbell Curls", "STRENGTH", "ARMS", "BARBELL", "INTERMEDIATE",
// 4.0,
...
// new Exercise("Dumbbell Lunges", "STRENGTH", "LEGS", "DUMBBELL",
// "INTERMEDIATE", 5.0,
...
// new Exercise("Incline Crunches", "STRENGTH", "CORE", "MACHINE", "BEGINNER",
// 4.0,
...
// new Exercise("Mountain Climbers", "STRENGTH", "CORE", "NONE", "INTERMEDIATE",
// 8.0,
...
// new Exercise("Battle Ropes", "CARDIO", "FULL_BODY", "NONE", "INTERMEDIATE",
// 11.0,
// "High-intensity rope exercise",
// "Alternate arms creating waves with heavy ropes"),
// new Exercise("Sprint Intervals", "CARDIO", "FULL_BODY", "NONE",
// "INTERMEDIATE", 12.0,
// "High-intensity running", "30 seconds sprint, 30 seconds rest cycles"),

// // FLEXIBILITY/YOGA EXERCISES
// new Exercise("Yoga Flow", "FLEXIBILITY", "FULL_BODY", "NONE", "BEGINNER",
// 3.0,
// "Basic yoga sequence", "Flow through poses with controlled breathing"),
// new Exercise("Static Stretching", "FLEXIBILITY", "FULL_BODY", "NONE",
// "BEGINNER", 2.0,
// "Hold stretches for flexibility",
// "Hold each stretch for 15-30 seconds"),
// new Exercise("Dynamic Stretching", "FLEXIBILITY", "FULL_BODY", "NONE",
// "BEGINNER", 3.0,
...
// new Exercise("Shoulder Stretches", "FLEXIBILITY", "SHOULDERS", "NONE",
// "BEGINNER", 2.0,
// "Shoulder mobility", "Stretches to improve shoulder flexibility"),

// // FUNCTIONAL EXERCISES
// new Exercise("Farmer's Walk", "STRENGTH", "FULL_BODY", "DUMBBELL",
// "INTERMEDIATE", 5.0,
// "Loaded carry exercise",
// "Hold heavy weights and walk for distance/time"),
// new Exercise("Turkish Get-Up", "STRENGTH", "FULL_BODY", "DUMBBELL",
// "ADVANCED", 6.0,
...
// new Exercise("Medicine Ball Slams", "STRENGTH", "FULL_BODY", "NONE",
// "INTERMEDIATE",
// 8.0,
...
// // WARM-UP EXERCISES
// new Exercise("Arm Circles", "FLEXIBILITY", "SHOULDERS", "NONE", "BEGINNER",
// 2.0,
...
// new Exercise("Clean and Press", "STRENGTH", "FULL_BODY", "BARBELL",
// "ADVANCED", 8.0,
...
// new Exercise("Thrusters", "STRENGTH", "FULL_BODY", "BARBELL", "ADVANCED",
// 7.5,
// "Squat to press combination", "Front squat into overhead press"),
// new Exercise("Man Makers", "STRENGTH", "FULL_BODY", "DUMBBELL", "ADVANCED",
// 9.0,
